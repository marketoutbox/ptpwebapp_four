      ...
      {isLoading && (
        <div className="flex justify-center my-8">
          <div className="relative w-16 h-16">
            <div className="absolute top-0 left-0 w-full h-full rounded-full border-4 border-blue-800/30"></div>
            <div className="absolute top-0 left-0 w-full h-full rounded-full border-4 border-t-yellow-400 animate-spin"></div>
          </div>
        </div>
      )}
          ...
          <div className="overflow-x-auto">
            <div className="max-h-64 overflow-y-auto">
              <table className="min-w-full modern-table">
                <thead className="glass-dark sticky top-0">
                  <tr>
                    <th className="text-left text-blue-300">Date</th>
                    <th className="text-left text-blue-300">{selectedPair.stockA} Close</th>
                    <th className="text-left text-blue-300">{selectedPair.stockB} Close</th>
                    <th className="text-left text-blue-300">Hedge Ratio (β)</th>
                    <th className="text-left text-blue-300">Spread (A - βB)</th>
                    <th className="text-left text-blue-300">Z-score</th>
                  </tr>
                </thead>
        ...
        <Card title="Trade Results">
          ...
          <div className="mt-6 grid grid-cols-1 md:grid-cols-4 gap-4">
            <div className="glass rounded-xl p-4">
              ...
              <p className="text-2xl font-bold gradient-text">{tradeResults.length}</p>
            </div>
            <div className="glass rounded-xl p-4">
            ...
            <div className="glass rounded-xl p-4">
              ...
              <p className="text-2xl font-bold gradient-text">{winRate.toFixed(1)}%</p>
            </div>
            <div className="glass rounded-xl p-4">
