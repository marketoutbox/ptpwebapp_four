  ...
  return (
    <div className="space-y-8">
      <div className="text-center mb-12">
        <h1 className="text-5xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-blue-100 to-blue-300">
          Pair Trading Platform
        </h1>
        <p className="text-xl text-blue-200 max-w-3xl mx-auto opacity-90">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
        <Link href="/stocks" className="block">
          <Card className="h-full transition-all duration-300 hover:translate-y-[-4px] hover:shadow-glow">
            <div className="flex flex-col items-center text-center p-4">
              <div className="w-16 h-16 bg-gradient-to-br from-blue-800/50 to-blue-700/50 rounded-full flex items-center justify-center mb-4 shadow-soft">
                <svg
              ...
              <p className="text-blue-200 opacity-90">Fetch and manage stock data from various sources</p>
            </div>
          </Card>
        </Link>
        ...
        <Link href="/backtest" className="block">
          <Card className="h-full transition-all duration-300 hover:translate-y-[-4px] hover:shadow-glow">
            <div className="flex flex-col items-center text-center p-4">
              ...
              <p className="text-blue-200 opacity-90">Backtest pair trading strategies using price ratios</p>
            </div>
          </Card>
        </Link>
        ...
        <Link href="/backtest-spread" className="block">
          <Card className="h-full transition-all duration-300 hover:translate-y-[-4px] hover:shadow-glow">
            <div className="flex flex-col items-center text-center p-4">
              ...
              <p className="text-blue-200 opacity-90">Backtest pair trading strategies using price spreads</p>
            </div>
          </Card>
        </Link>
      </div>
      ...
      <Card className="mt-12">
        <div className="p-4">
          ...
          <p className="text-blue-200 mb-4 leading-relaxed opacity-90">
          ...
          <p className="text-blue-200 leading-relaxed opacity-90">
