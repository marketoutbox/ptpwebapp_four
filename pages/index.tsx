    ...
    <div className="space-y-8">
      <div className="text-center py-12">
        <h1 className="text-5xl font-bold text-blue-100 mb-4">
          <span className="gradient-text">Pair Trading</span> Platform
        </h1>
        ...
        <Link href="/stocks" className="block">
          <Card className="h-full hover-lift">
            <div className="flex flex-col items-center text-center p-6">
              <div className="w-16 h-16 bg-gradient-to-br from-blue-800 to-blue-700 rounded-full flex items-center justify-center mb-4 shadow-glow">
                <svg
              ...
              <p className="text-blue-200 opacity-80">Fetch and manage stock data from various sources</p>
            </div>
          </Card>
        </Link>
        ...
        <Link href="/backtest" className="block">
          <Card className="h-full hover-lift">
            <div className="flex flex-col items-center text-center p-6">
              ...
              <p className="text-blue-200 opacity-80">Backtest pair trading strategies using price ratios</p>
            </div>
          </Card>
        </Link>
        ...
        <Link href="/backtest-spread" className="block">
          <Card className="h-full hover-lift">
            <div className="flex flex-col items-center text-center p-6">
              ...
              <p className="text-blue-200 opacity-80">Backtest pair trading strategies using price spreads</p>
            </div>
          </Card>
        </Link>
      </div>
      ...
      <Card className="mt-12">
        <div className="p-6">
          ...
          <p className="text-blue-200 mb-4 opacity-90 leading-relaxed">
          ...
          <p className="text-blue-200 opacity-90 leading-relaxed">
