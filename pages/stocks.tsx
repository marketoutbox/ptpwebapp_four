  ...
  return (
    <div className="space-y-6">
      <div className="text-center mb-8">
        <h1 className="text-3xl font-bold text-blue-50 mb-2">Stock Data Management</h1>
        <p className="text-blue-200 opacity-80">Fetch and manage stock data from Yahoo Finance</p>
      </div>

      <Card>
        <div className="space-y-5">
          <div>
            <label htmlFor="symbols" className="block text-sm font-medium text-blue-200 mb-2">
              Stock Symbols
            </label>
            <Input
              id="symbols"
            ...
            />
            <p className="mt-2 text-sm text-blue-300 opacity-80">
              Enter comma-separated stock symbols to fetch or load data
            </p>
          </div>
          ...
          {message.text && (
            <div
              className={`p-4 rounded-md backdrop-blur-sm ${
                message.type === "success"
                  ? "bg-green-900/20 text-green-200 border border-green-800/20"
                  : message.type === "error"
                    ? "bg-red-900/20 text-red-200 border border-red-800/20"
                    : "bg-yellow-900/20 text-yellow-200 border border-yellow-800/20"
              }`}
            >
              {message.text}
            </div>
